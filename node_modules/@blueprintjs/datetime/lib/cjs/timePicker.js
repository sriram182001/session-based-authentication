...
exports.TimePicker = exports.TimePrecision = void 0;
...
var TimePicker = /** @class */ (function (_super) {
    ...
    TimePicker.prototype.render = function () {
        ...
        var classes = (0, classnames_1.default)(Classes.TIMEPICKER, this.props.className, (_a = {},
    ...
    TimePicker.prototype.maybeRenderArrowButton = function (isDirectionUp, timeUnit) {
        ...
        var classes = (0, classnames_1.default)(Classes.TIMEPICKER_ARROW_BUTTON, (0, timeUnit_1.getTimeUnitClassName)(timeUnit));
        ...
        return (React.createElement("span", { tabIndex: -1, className: classes, onClick: onClick },
            React.createElement(core_1.Icon, { icon: isDirectionUp ? "chevron-up" : "chevron-down", title: isDirectionUp ? "Increase" : "Decrease" })));
    };
    ...
    TimePicker.prototype.shiftTime = function (unit, amount) {
        ...
        var newTime = (0, timeUnit_1.getTimeUnit)(unit, this.state.value) + amount;
    ...
    TimePicker.prototype.updateState = function (state) {
        ...
        if (this.props.value == null) {
            ...
            if (hasNewValue) {
                ...
                this.setState(tslib_1.__assign(tslib_1.__assign({}, newState), { value: DateUtils.clone(this.state.value) }));
            }
        }
        if (hasNewValue) {
    ...
    TimePicker.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".TimePicker");
    return TimePicker;
}(React.Component));
