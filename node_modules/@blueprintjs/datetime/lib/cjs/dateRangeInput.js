...
var DateRangeInput = /** @class */ (function (_super) {
    ...
    function DateRangeInput(props, context) {
        ...
        _this.handleInputFocus = function (_e, boundary) {
            ...
            var inputString = (0, dateFormat_1.getFormattedDateString)(values.selectedValue, _this.props, true);
        ...
        _this.handleInputBlur = function (_e, boundary) {
            ...
            if (_this.isInputEmpty(values.inputString)) {
                if (isValueControlled) {
                    nextState = tslib_1.__assign(tslib_1.__assign({}, nextState), (_b = {}, _b[keys.inputString] = (0, dateFormat_1.getFormattedDateString)(values.controlledValue, _this.props), _b));
                }
                else {
        ...
        _this.getIsOpenValueWhenDateChanges = function (nextSelectedStart, nextSelectedEnd) {
            if (_this.props.closeOnSelection) {
                ...
                if ((0, dateUtils_1.areSameTime)(selectedStart, nextSelectedStart) === true &&
                    (0, dateUtils_1.areSameTime)(selectedEnd, nextSelectedEnd) === true) {
                    return false;
                }
                return true;
            }
        ...
        _this.getInputDisplayString = function (boundary) {
            ...
            if (hoverString != null) {
                ...
                return (0, dateFormat_1.getFormattedDateString)(selectedValue, _this.props);
            }
        };
        ...
        _this.isDateValidAndInRange = function (date) {
            return (0, dateUtils_1.isDateValid)(date) && (0, dateUtils_1.isDayInRange)(date, [_this.props.minDate, _this.props.maxDate]);
        };
        _this.reset(props);
        return _this;
    }
    ...
    DateRangeInput.prototype.componentDidUpdate = function (prevProps, prevState) {
        ...
        if (this.props.value !== prevProps.value) {
            ...
            nextState = tslib_1.__assign(tslib_1.__assign({}, nextState), { selectedStart: selectedStart, selectedEnd: selectedEnd });
        }
    ...
    DateRangeInput.prototype.render = function () {
        ...
        var popoverClassName = (0, classnames_1.default)(popoverProps.className, this.props.className);
        // allow custom props for the popover and each input group, but pass them in an order that
        // guarantees only some props are overridable.
        return (
        /* eslint-disable-next-line deprecation/deprecation */
        React.createElement(core_1.Popover, tslib_1.__assign({ isOpen: this.state.isOpen, position: core_1.Position.BOTTOM_LEFT }, this.props.popoverProps, { autoFocus: false, className: popoverClassName, content: popoverContent, enforceFocus: false, onClose: this.handlePopoverClose }),
    ...
    DateRangeInput.prototype.getFormattedMinMaxDateString = function (props, propName) {
        ...
        return (0, dateFormat_1.getFormattedDateString)(date === undefined ? defaultDate : date, this.props);
    };
    ...
    DateRangeInput.displayName = "".concat(core_1.DISPLAYNAME_PREFIX, ".DateRangeInput");
